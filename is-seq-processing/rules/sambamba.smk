rule sambamba_index:
    input:
        'result/02_bwa/{exp}.sorted.bam'
    output:
        'result/02_bwa/{exp}.sorted.bam.bai'
    threads: 1
    log: 'logs/sambamba_index/{exp}.log'
    benchmark: 'benchmarks/sambamba_index/{exp}.benchmark'
    wrapper:
...
rule sambamba_sort:
    ...
    params:
        ...
        show_progress = False,
    threads: 1
    log: 'logs/sambamba_sort/{exp}.log'
    benchmark: 'benchmarks/sambamba_sort/{exp}.benchmark'
    wrapper:
