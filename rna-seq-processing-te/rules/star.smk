...
def star_2_pass_input(wildcards):
    ...
    ret = {}
    ret['star_index'] = config['star_index_dir']

    if lib.upper().startswith('SINGLE'):
        ret['reads'] = [
            str(RESULT_DIR / '01_trim_galore' / '{sample}.trimmed.fastq.gz')
        ]

    else:
        ret['reads'] = [
            str(RESULT_DIR / '01_trim_galore' / '{sample}.read1.trimmed.fastq.gz'),
            str(RESULT_DIR / '01_trim_galore' / '{sample}.read2.trimmed.fastq.gz'),
        ]

    return ret

c = config['star_2_pass']
rule star_2_pass:
    input: unpack(star_2_pass_input)
    output:
        ...
        genome_alignment = RESULT_DIR / '02_star' / '{sample}{rep}.sorted.bam',
        # Aligning to transcriptome is optional.
        # NOTE: You should set quantMode to 'TranscriptomeSAM' to get 
        # this output.
        transcriptome_alignment = RESULT_DIR / '02_star' / '{sample}{rep}.transcriptome.bam',
    ...
    params:
        ...
        # Default: False
        sjdb_file_chr_start_end = c['sjdb_file_chr_start_end'],
        # It is recommended to give gene annotation file in at least one of
        # genomeGeneration or 2_pass step.
        # Also it is recommened to use GENCODE annotation file, either of GTF of GFF3 file.
        # Don't forget to specify sjdb_gtf_tag_exon_parent_transcript = 'Parent'
        ...
        sjdb_gtf_file = c['sjdb_gtf_file'],
        # If genome is from UCSC, and annotation is from ENSEMBL,
        # use sjdb_gtf_chr_prefix = 'chr'
        sjdb_gtf_chr_prefix = c['sjdb_gtf_chr_prefix'],
        # Length of the donor/acceptor sequence on each side of the junctions,
        # ideally, (maxReadLength - 1).
        # In most cases, the default value of 100 will work well.
        sjdb_overhang = c['sjdb_overhang'],
        # If you use GFF3 annotation file,
        # use sjdb_gtf_tag_exon_parent_transcript = 'Parent'
        sjdb_gtf_tag_exon_parent_transcript = c['sjdb_gtf_tag_exon_parent_transcript'],
        ### Output filtering
        # Type of filtering.
        ...
        # Default: Normal
        out_filter_type = c['out_filter_type'],
        # The score range below the maximum score for multimapping alignments.
        # Default: 1
        out_filter_multimap_score_range = c['out_filter_multimap_score_range'],
        ...
        # Default: None
        out_filter_intron_motifs = c['out_filter_intron_motifs'],
        # Filter alignments
        ...
        out_filter_intron_strands = c['out_filter_intron_strands'],
        ...
        # Default: All
        out_sj_filter_reads = c['out_sj_filter_reads'],
        ...
        # Default: '30 12 12 12'
        out_sj_filter_overhang_min = c['out_sj_filter_overhang_min'],
        ...
        # This does not apply to annotated junctions.
        # Default: '3 1 1 1'
        out_sj_filter_count_unique_min = c['out_sj_filter_count_unique_min'],
        ...
        # This does not apply to annotated junctions.
        # Default: '3 1 1 1'
        out_sj_filter_count_total_min = c['out_sj_filter_count_total_min'],
        # Minimum allowed distance to other junctions' donor/acceptor.
        # This does not apply to annotated junctions.
        # Default: '10 0 5 10'
        out_sj_filter_dist_to_other_sj_min = c['out_sj_filter_dist_to_other_sj_min'],
        ...
        out_sj_filter_intron_max_vs_read_n = c['out_sj_filter_intron_max_vs_read_n'],
