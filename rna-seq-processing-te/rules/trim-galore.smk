...
rule trim_galore_se:
    ...
    output:
        temp(RESULT_DIR / '01_trim_galore' / '{sample}.trimmed.fastq.gz')
    params:
        extra = c['extra'],
        ...
        # Default: False
        three_prime_clip_R1 = c['three_prime_clip_R1'],
        ...
        # Default: False
        three_prime_clip_R2 = c['three_prime_clip_R2'],
        ...
        # Default: False
        retain_unpaired = c['retain_unpaired'],
...
rule trim_galore_pe:
    ...
    output:
        temp(RESULT_DIR / '01_trim_galore' / '{sample}.read1.trimmed.fastq.gz'),
        temp(RESULT_DIR / '01_trim_galore' / '{sample}.read2.trimmed.fastq.gz'),
    params:
        extra = c['extra'],
        # Trim low-quality ends from reads in addition to adapter removal. For RRBS samples,
        # quality trimming will be performed first, and adapter trimming is carried in a second round.
