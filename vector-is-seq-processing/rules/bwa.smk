def get_reference(wildcards):
    if wildcards.exp.startswith('26'):
        return 'reference/bwa_index/hg38_psh26.bwt'
    elif wildcards.exp.startswith('36'):
        return 'reference/bwa_index/hg38_psh36.bwt'
    else:
...
rule bwa_mem:
    input:
        ...
        reads = [
            'result/01_cutadapt/{exp}.read1.trimmed.fastq.gz',
            'result/01_cutadapt/{exp}.read2.trimmed.fastq.gz',
        ],
        ...
        # reference = 'reference/bwa_index/hg38_psh26.bwt',
    ...
    params:
        ...
        R = r"'@RG\tID:{exp}\tSM:{exp}\tPL:ILLUMINA'",
        ...
        I = False,
    threads: 8
    log: 'logs/bwa_mem/{exp}.log'
    benchmark: 'benchmarks/bwa_mem/{exp}.benchmark'
    wrapper:
...
rule get_reference_from_cloud:
    output:
        'reference/{ref}.fa'
    shell:
        'wget https://dohlee-bioinfo.sgp1.digitaloceanspaces.com/hiv1-rloop/{wildcards.ref}.fa -O {output}'
...
rule bwa_index:
    ...
    output:
        ...
        'reference/bwa_index/{ref}.amb',
        'reference/bwa_index/{ref}.ann',
        'reference/bwa_index/{ref}.bwt',
        'reference/bwa_index/{ref}.pac',
        'reference/bwa_index/{ref}.sa'
    params:
        extra = '',
    ...
    benchmark: 'benchmarks/bwa_index/{ref}.log'
    wrapper:
